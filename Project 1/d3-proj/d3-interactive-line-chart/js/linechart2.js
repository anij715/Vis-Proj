class LineChart2 {
    ...
    updateVis() {
        let vis = this;
        vis.xValue = d => d.year;
        if (vis.config.displayType == "CO") {
            vis.yValue = d => d.DaysCO_p;
            vis.line = d3.line()
        ...
        } else if (vis.config.displayType == "NO2") {
            vis.yValue = d => d.DaysNO2_p;
            vis.line = d3.line()
                .x(d => vis.xScale(vis.xValue(d)))
                .y(d => vis.yScale(vis.yValue(d)));
            // Set the scale input domains
        ...
        } else if (vis.config.displayType == "Ozone") {
            vis.yValue = d => d.DaysOzone_p;
            vis.line = d3.line()
                .x(d => vis.xScale(vis.xValue(d)))
                .y(d => vis.yScale(vis.yValue(d)));
            // Set the scale input domains
        ...
        } else if (vis.config.displayType == "SO2") {
            vis.yValue = d => d.DaysSO2_p;
            vis.line = d3.line()
                .x(d => vis.xScale(vis.xValue(d)))
                .y(d => vis.yScale(vis.yValue(d)));
            // Set the scale input domains
        ...
        } else if (vis.config.displayType == "PM25") {
            vis.yValue = d => d.DaysPM2_5_p;
            vis.line = d3.line()
                .x(d => vis.xScale(vis.xValue(d)))
                .y(d => vis.yScale(vis.yValue(d)));
            // Set the scale input domains
        ...
        } else if (vis.config.displayType == "PM10") {
            vis.yValue = d => d.DaysPM10_p;
            vis.line = d3.line()
                .x(d => vis.xScale(vis.xValue(d)))
                .y(d => vis.yScale(vis.yValue(d)));
            // Set the scale input domains
